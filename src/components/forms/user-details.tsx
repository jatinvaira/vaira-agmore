  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>Add or update your infromation</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
                ...
                <FormItem className="flex-1">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      ...
                      field.onChange(value); // Corrected typo
                    }}
                    defaultValue={field.value} // Corrected typo
                  >
                    <FormControl>
                      <SelectTrigger>
            ...
            {authUserData?.role === "AGENCY_OWNER" && (
              <div>
                ...
                <FormDescription className="mb-4">
                  You can give SubAccount access to team member by turning on
                  acccess control for each subaccount. This is only visible to
                  agency owners
                </FormDescription>
